...
var lexicon = {
  "adj": {
    ...
    "semet": ["numerical"],
    "shit": ["high-quality"],
    "shyxeht": ["arbitrary", ["archaic", "shyxet"]],
    "shyxet": ["arbitrary"],
    ...
    "thelnfemek": ["clever"],
    "thik": ["thin (of an object)"],
    "thin": ["large (of a person)"],
    "thnelxmyt": ["flat"],
    "thnoln": ["free", "unrestrained"],
    "tishnim": ["sleepy"],
    "tivemolk": ["tiny", "very small"],
    "tizholn": ["oceanic", "marine"],
    "tolthim": ["majestic"],
    "tolthimgolt": ["sufficient", "satisfactory", "complete", "useable", "enough"],
    "toltuhsacen": ["naughty", "inappropriate", "lewd"],
    "tulcek": ["lonely"],
    "tulcykyk": ["physically or literally pure", "incomplete", "diluted", ["etymology", "tuhkykyk + -tuc"]],
    "tyc": ["bad", ["see also", "ok"]],
    "vajem": ["exactly 1 of"],
    "vajolm": ["solitary"],
    "van": ["odd", "strange", "weird", "absurd", "unusual", "pertaining to Sajem Tan"],
    "vazhnuhsnolm": ["enriched"],
    "velvet": ["shy"],
    "viten": ["weak"],
    "vmelfelc": ["crazy"],
  ...
  "aux": {
    ...
    "ol": {
      ...
      "solk": [["form", "s", "k"], "please clarify", "indicates that the speaker perceives a contradiction"]
    }
  },
  "color": {
  ...
  "noun": {
    ...
    "famat": ["farm"],
    "fasnat": ["powdered donut", "powdered doughnut", "a holiday that originally had meaning but now people just celebrate it for the food or other superficial characteristics", "soap", ["see also", "kagan"]],
    "femek": ["mind", "thought", "Sherlock Holmes"],
    "femektam": ["gender", "gender identity", ["see also", "zlannoc"]],
    ...
    "fic": ["here", "now"],
    "fijyc": ["rainbow"],
    "fithnelm": ["lighthouse", "beacon", ["see also", "canim"]],
    "fmakaxik": ["catapult", "trebuchet", ["etymology", "fmamegyn + kaxik"]],
    "fmat": ["seed"],
    ...
    "geselt": ["chest", "box", "large container", "theater of war"],
    ...
    "jyt": ["place", ["etymology", "jymin"], "space (not strictly outer)", "spot", "location"],
    "jythak": ["strawberry"],
    "kacfic": ["past"],
    "kafemuhm": ["cryptomnesia", "false memories"],
    "kagan": ["hula-hoop", "donut", "doughnut", ["see also", "fasnat"]],
    ...
    "muhcjulvet": ["surname", "last name (in cultures with a European-like naming system)", ["archaic", "muhcjulvolt"]],
    "muhcjulvolt": ["surname", "last name (in cultures with a European-like naming system)"],
    ...
    "nuln": ["friend"],
    "nulnjulvet": ["nickname", ["archaic", "nulnjulvolt"]],
    "nulnjulvolt": ["nickname"],
    "nulvmic": ["charcoal"],
    ...
    "tam": ["gender", "sex", ["see also", "femektam"], ["see also", "zlannoc"]],
    ...
    "vakultjulvet": ["given name", "first name (in cultures with a European-like naming system)", ["archaic", "vakultjulvolt"]],
    "vakultjulvolt": ["given name", "first name (in cultures with a European-like naming system)"],
    "vavmyn": ["anarchy"],
    ...
    "zhan": ["one-handed sword", "dagger", "knife", "blade (of a blender, not a fan)", ["see also", "dyznek"], ["gloss", "sword"]],
    ...
    "zizulm": ["library"],
    "zlannoc": ["gender", ["see also", "femektam"], ["see also", "tam"]],
    "zlantak": ["domino"],
    ...
    "selset": ["sushi"],
    "zlulven": ["sandwich"],
    "canim": ["lighthouse", ["see also", "fithnelm"]],
    "midac": ["puzzle"],
    ...
    "julvetselsetukmunzlisoln": ["identity crisis"],
    "teslin": ["spoonerism"],
    "znolvulc": ["mushroom"],
    "zhajek": ["ocelot"],
    "shaslaxac": ["Hormone"],
    "zlulsak": ["psychological horror"],
    "fefuhzlac": ["capsule", "pod (for people)"],
    "fefuhzlaczlulsac": ["Extreme claustrophobia"],
    "zhasikzhuhzhuhmzansofefuhzlac": ["Space capsule/module"],
    "tolgelculm": ["flatbread", "cracker", "unleavened bread"],
    "znyvuhc": ["mycelium"],
    "zasat": ["lettuce"],
    "kygekslysyc": ["boa constrictor"],
    "delsym": ["deal", "commitment", "consent", "promise", "oath"],
    "slinkaxik": ["tank (vehicle)"],
    "xithnolm": ["phoenix"],
    "xaxithnolmat": ["phenox"],
    "xithnolmzhiman": ["phoenix feather", "candle"],
    "kishnulmnoc": ["gyro (food)", "shawarma", "döner kebab"],
    "xexat": ["evil wind", "laughing wind", "storm", "gale"],
    "gulsoln": ["disgust", ["etymology", "gulk + zlisoln"]],
    "ciculsak": ["Minecraft Creeper", ["etymology", "ciculm + zlulsak"]],
    "tythemekzhum": ["Minecraft Silverfish"],
    "gamykfun": ["sapling"],
    "zicthefam": ["lava", "magma"],
    "thefamfunmon": ["gravel"],
    "jytcesik": ["adposition"],
    "kacjytcesik": ["preposition"],
    "zultjytcesik": ["postposition"],
    "slinkam": ["weapon"],
    "mesnanzic": ["potion"],
    "jafitulzhnolm": ["map"],
    "slaslat": ["guacamole"],
    ...
    "cen": ["line", "row", "line of poetry or prose"],
    ...
    "cicsofun": ["quesadilla"],
    "slelzlen": ["jellyfish"],
    "tizholngafnulmgyn": ["pirate"],
    "celmuln": ["wasp"],
    "celmulndin": ["wasphive", "The Wasphive"],
    "snedelmtan": ["cipher", "code", "language that is difficult to decipher"],
    "tekeziselttan": ["computer code"],
    "thafim": ["a boulder", "especially one that can roll"],
    "tulxyk": ["a sailboat or sailing ship", "a watercraft propelled by sails"],
    "netin": ["cherry"],
    "thuhsin": ["fallen leaf", "autumnal leaf"],
    "fmatuhm": ["conifer cone"],
    "slolsluhthnamyvnik": ["turmeric"],
    "celnyc": ["ginger (spice)"],
    "melnathik": ["sugar", "especially granulated sugar"],
    "nulnen": ["saffron"],
    "mamolk": ["spice"],
    "tuhkykyt": ["mixture, especially of spices", "balance", "combination", "equilibrium"],
    "zheculc": ["cardamom"],
    "juhcennesit": ["chili pepper"],
    "mynelnanek": ["powder"],
    "nimulcolmec": ["ghost pepper (Bhut Jolokia)"],
    "dolkjuhcennesit": ["bell pepper"],
    "feltjuhcennesit": ["jalapeno"],
    "slolcjuhcennesit": ["habanero"],
    "xekjuhcennesit": ["carolina reaper"],
    "vykjuhcennesit": ["cayenne pepper"],
    "juhcennesitmynelnanek": ["paprika"],
    "tem": ["salt"],
    "tazlikec": ["vinegar"],
    "mamolcinan": ["onion"],
    "mamelcynan": ["garlic"],
    "zanulk": ["acid", "something acidic"],
    "mislelnzanulk": ["citric acid"],
    "tatulm": ["tomato"],
    "tultaslam": ["potato"],
    "culzhitikulm": ["carrot"],
    "thuhvinenenak": ["guajillo pepper"],
    "nelculm": ["grain"],
    "nelculmfun": ["wheat"],
    "duhtnelculm": ["corn"],
    "tivemolknelculm": ["quinoa"],
    "netuhtuhsec": ["butter"],
    "gevmulksoljemmamolk": ["vanilla"],
    "xafnolt": ["cinnamon"],
    "xefnuht": ["fennel"],
    "xolfnuht": ["mustard seed"],
    "kuhtynak": ["paste", "sauce"],
    "xuhfnuht": ["black pepper (peppercorn)"],
    "tatulmkuhtynat": ["ketchup"],
    "xolfnuhtkuhtynak": ["mustard"],
    "snatoln": ["lime"],
    "thak": ["berry"],
    "gevmulkthak": ["peanut"],
    "gyntivemolk": ["microbe"],
    ...
    "xulfnolt": ["thyme"],
    "tolzlnelnukmun": ["oil"],
    "metedulk": ["culinary/nutritional fat"],
    "metedulkxehtkemenzamin": ["skim milk"],
    "tulvatoltytolmetelsemakik": ["exceedingly long word"],
    "kulnolm": ["vinyl record"],
    "tatemat": ["record player"],
    "tetyt": ["king", "queen", "monarchical ruler"],
    "nulzuht": ["venus fly trap"],
    "colkemenekek": ["hearth"],
    "nolcam": ["toe"],
    "mmemifikec": ["calf (part of leg)"],
    "gislult": ["knee"],
    "memic": ["thigh"],
    "kecek": ["short hair"],
    ...
    "temet": ["pie"],
    "telmoltfun": ["cupcake"],
    "matam": ["dry, plain biscuit"],
    "zimanykulm": ["skin"],
    "zholslelzlolm": ["tongue twister"],
    "tolcen": ["efficiency"],
    "thezen": ["when fog and wind smipe at each other"],
    "zletuhzlekinyn": ["allspice"],
    "katymatholslolm": ["anise"],
    "kuhslak": ["buttercup"],
    "ganakicikelm": ["basil"],
    "fnynjafit": ["peninsula"],
    "mulfynamym": ["bay", "gulf"],
    "kelcolkamelk": ["bay leaf"],
    "nelculmmelnathik": ["granulated sugar"],
    "tymyt": ["a puffed pastry"],
    "cetikafit": ["power", "physical strength"],
    "nulslyt": ["clove"],
    "solkamekulthelm": ["nutmeg"],
    "cuhmulcitat": ["beetroot"],
    "snak": ["meal"],
    "mitik": ["snack"],
    "kavemecolzolk": ["longfin", "a fish found in the lakes of the Gavmolt region"],
    "fekynik": ["cucumber"],
    "misymemult": ["opossum"],
    "slygyn": ["butterfly"],
    "kaksnitinslygyn": ["moth"],
    "zultolm": ["antelope"],
    "safavycit": ["stingray"],
    "zlaslolkzhizlik": ["archerfish"],
    "kamyn": ["grasshopper"],
    "tholcishnuhk": ["beetle"],
    "zatolk": ["eel"],
    "slefolvaslnynen": ["assassin bug"],
    "finuhnamacec": ["badger"],
    "zlivmynzhizlik": ["shark"],
    "cecatim": ["whisker"],
    "cecatimzhizlik": ["catfish"],
    "duhtduhk": ["pike (weapon)"],
    "zlynuhcac": ["pike (fish)"],
    "solzholcem": ["squid"],
    "kulksolzholcem": ["octopus"],
    "solzholcemkyfik": ["tentacle"],
    "kevyfytvmadanso": ["boar"],
    "shasholmanynult": ["hawk"],
    "kevyfytzhnicoln": ["wolf"],
    "fmaslnolt": ["trout"],
    "shelshelnsazycfenat": ["bactrian camel"],
    "tyvym": ["dromedary camel"],
    "migizolmemim": ["rat"],
    "synicykityn": ["mouse"],
    "fmelslnuht": ["salmon"],
    ...
    "thelkuhm": ["dolphin"],
    "cetim": ["eagle"],
    "noltazlitazhim": ["preying mantis"],
    "sikuhm": ["crab"],
    "culcytitamat": ["fox"],
    "golk": ["frog"],
    "kelnulmamyn": ["scorpion"],
    "xeltelt": ["turtle"],
    "molmatinevult": ["hare"],
    "tyzhnizuhtamym": ["carp"],
    "zolkitiznym": ["jackal"],
    "zlelnynatyseln": ["adder"],
    "molcycemultic": ["viper"],
    "zhynin": ["lion"],
    "slitac": ["whale"],
    "zinamuht": ["parrot"],
    "metakat": ["oyster"],
    "thelfem": ["gemstone, especially diamond"],
    "metakatthelfem": ["pearl"],
    "teltek": ["pheasant"],
    "kyvynolsnemit": ["tiger"],
    "mazlavakajyn": ["sheep"],
    "muhmuhtak": ["piranha"],
    "cifikim": ["stink bug"],
    "tinenak": ["fly (animal)"],
    "jintinenak": ["firefly (lightning bug)"],
    "jafitvmadanso": ["aardvark"],
    "tolmavoltyn": ["bamboo"],
    "jatetykulcet ": ["henbane"],
    "telmefimin": ["jasmine"],
    "thekeltolnulcoln": ["petunia"],
    "mynakelcatet": ["nightshade"],
    "fycetim": ["mandrake"],
    "cajicyt": ["slug"],
    "thitythik": ["popcorn"],
    "slaslulm": ["shrimp"],
    "thuhfamslafyc": ["railroad"],
    "solceknesit": ["banana"],
    "kenakolm": ["chip", "in the American sense(not neccesarily of potato)"],
    "zelvetdat": ["sunrise", "morning"],
    "melt": ["culinary dip"],
    "nelculmmynelnanek": ["flour"],
    "snuhsulshuln": ["ingredient"],
    "zekizulshmeshnuln": ["barley"],
    "thnafnolm": ["niacin"],
    "kemoln": ["deer"],
    "tit": ["soybean"],
    "titnetuhtuhsec": ["margarine"],
    "xnesen": ["sesame"],
    "xisanic": ["cumin"],
    "snolxmolzhyslmac": ["asafoetida"],
    "xislazlikuhslinatoln": ["hot sauce"],
    "gyxan": ["entry, as in a diary or encyclopedia", "article", "instalment", "update"],
    "zultznolk": ["tomorrow", "the next day"],
    "xexengolt": ["solution"],
    "zulshinelzuln": ["walled city"],
    "zulshin": ["wall", "especially one that encloses"],
    "snatjelkelm": ["textbook"],
    "xuljan": ["dialect"],
    "cyzen": ["A conversation in two people snipe at each other about a peice of work, usually scientific", "A conversation in which Algae and Fog snipe at each other about Sajem Tan grammar"],
    "znan": ["synopsis", "usually humorous", ["etymology", "znenan - en"]],
    "magic": ["furniture", "especially wicker furniture"],
    "nelgyn": ["uncrustable"],
    "nelguln": ["round food"],
    "nelgoln": ["bread roll"],
    "nelgykuhtynak": ["a drink made from liquifying another, normally processed, food"],
    "nigin": ["(fish) scale"],
    "duhtthnu": ["a turn (in a game)"],
    "gevmulkthakkuhtynak": ["peanut butter"],
    "gevmulthakkuhtynakzlulven": ["peanut butter sandwich"],
    "duhganmehtgevmulkthakkuhtynakzlulven": ["uncrustable"],
    "duhtduhganmehtgevmulkthakkuhtynakzlulvenslinthnu": ["Great Uncrustable War"],
    "slythezlin": ["basilisk"],
    "denin": ["pine tree"],
    "deninfmatuhm": ["pine cone"],
    "mizoln": ["spruce tree"],
    "zlolvam": ["cedar tree"],
    "mifin": ["fir tree"],
    "thuhsingamyk": ["deciduous tree"],
    "fmatuhmgamyk": ["coniferous tree", "conifer"],
    "thuhkit": ["oak tree", ["etymology", "thuhsin + thikit"]],
    "melnazic": ["syrup", ["etymology", "melnathik + zic)"]],
    "melnazicuhm": ["maple tree", ["etymology", "melnazic + zicuhm"]],
    "fmigolk": ["badger"],
    "gafnigolk": ["raccoon; racoon", ["etymology", "gafnulm + fmigolk"]],
    "zlolvamit": ["cedar waxwing"],
    "vajem": ["unit", "whole"],
    "nanym": ["mail", "letter"],
    "vnajulm": ["velum"],
    "tholxuhm": ["gum ridge"],
    ...
    "shneljac": ["uvula"],
    "zledyzit": ["glottis"],
    "colmek": ["telepathic bonsai tree"],
    "xazlik": ["a type of flaky biscuit topped with sugar crystals"],
    "xmanikin": ["a tubular spicy snack"],
    "mat": ["rug, especially a coarse one"],
    "xifnyt": ["coriander (cilantro)"],
    "nigyt": ["wheel"],
    "shen": ["sensation", "physical or mental feeling (as opposed to emotional)"],
    "vajolm": ["that which is best on its own", "hermit"],
    "tulcek": ["one who is on their own despite not wanting to be"],
    "thuhfinfun": ["perch"],
    "thuhfinfunvithit": ["passerine", "perching bird"],
    "fynitkygynvithit": ["bird of prey"],
    "slingynvithit": ["bird of prey"],
    "kixikolmfun": ["hummingbird"],
    "thniduht": ["mime", "charades"],
    "gyznyttulceslit": ["incense"],
    "tasluhmnic": ["anointing oil"],
    "xytdolnthnu": ["cacophony"],
    "famatcic": ["cottage cheese"],
    "slneket": ["cashew"],
    "shaslik": ["sausage"],
    "jeslnisnelzhmek": ["fenugreek"],
    "dethek": ["writing script"],
    "toln": ["bell, especially one used as a musical instrument."],
    "cevnolt": ["vine", "ivy"],
    "fnulslam": ["antler"],
    "nanymgynkah": ["angel", "technical term for any incorporeal, ethereal, supernatural, or otherworldly functioning in a messenger role"],
    "cenmon": ["stanza (of poetry)", "verse (of poetry)", "passage (of prose)"],
    "xytmolmdin": ["world", ["see also", "cadelk"]],
    "molmdin": ["country", "territory", "tribal lands", "homeland", ["see also", "jafit"], ["see also", "muhc"]],
    "tuhtat": ["crown", ["etymology", "tetyt, tytyt + duhgan"]],
    "fydit": ["spirit", "bodiless being"],
    "nelnolk": ["veil"],
    "fefan": ["sheep"],
    "kelm": ["paper"],
    "janzlulc": ["something to show someone you care about them in some way"],
    "kelmjanzlulc": ["greeting card", "postcard"],
    "mesik": ["that bittersweet feeling of being disappointed at one's own elitism, purism, or snobbery regarding the morally harmless pursuits and interests of others"],
    "sladelk": ["bridge"],
    "shevet": ["meteor", "shooting star"],
    "tycaslam": ["one who partakes in degenerativity"],
    "vikazhyn": ["hay", "straw", "raffia"],
    "zhezlam": ["clay", "national property"],
    "zolshen": ["forgiveness", "reconciliation"],
    "zolshennoc": ["clean slate"],
    "xolzhym": ["owl"],
    "dejizolnxolzhym": ["barn owl"],
    "melsulnxolzhym": ["snowy owl"],
    "simemdin": ["monastery", "library", "a quiet place intended for study and enrichment"],
    "celnak": ["mason jar"],
    "mac": ["plastic"],
    "maceln": ["headmate"],
  ...
  "particle": {
    ...
    "tuhn": ["the quality/property of", ["example", "tuhn vmelfelc", "(that which has) the property of silliness/wisdom"]],
  ...
  "post": {
    ...
    "sajoln": ["deep in a set of internet links (usage archaic)"],
    "seln": ["to", "towards"],
    "shen": ["feel", "feel as though", ["etymology", "shehn"]],
    "sholmak": ["between"],
    ...
    "tan": ["said that"],
    "taznoln": ["until"],
    "tolthim": ["want", "desire that"],
    "tolthimnoc": ["request that"],
    "tuhn": ["having a quality/property (usage archaic)", ["gloss", "having"]],
  ...
  "suffix": {
    "adj>intrans": {
      "ehk": ["become", ["suf-example", "jam (new)", "jamehk (become new)"]],
    ...
    "noun>noun": {
      ...
      "fah": ["belongings of _", "property of _", "jurisdiction of _", "that which belongs to _", ["suf-example", "Tolzen (Fog)", "Tolzenfah (that which belongs to Fog)"]],
      "fun": ["small"],
      "jot": ["future", ["suf-example", "tetan (tetan)", "tetanjot (a tetan in the future)"]],
      "kah": ["energetic", "coffee", "hot"],
      "kahf": [["archaic", "kah"], "energetic", "coffee"],
      "mahk": ["improver"],
      "moc": ["follower of", "descendent of", "when appended to the end of a name, signifies the followers or tribe of that person", ["etymology", "muhc"]],
      "mon": ["collective noun", "a group of"],
      "nah": ["partitive plural", "some but not all", ["example", "thnamolk (pizza)", "thnamolknah (some pizzas)"]],
      "no": ["partitive singular", "some", ["suf-example", "thnamolk (pizza)", "thnamolkno (some pizza)"]],
    ...
    "pseudo-case": {
      ...
      "xehn": ["out of"],
      "zon": ["near to"],
      "zahn": ["nearing", "approaching"],
      "zun": ["far from"],
      "zehn": ["(motion) far from", "away from"],
      "vok": ["around", "surrounding"],
      "vahk": ["(motion) around", "can be used to mean 'surround'", ["suf-example", "xananzmet (house)", "xananzmetzahn (to surround a house)"]],
      ...
      "snum": ["atop", "on top of"],
      "snehm": ["to the top of"],
      "snom": ["beneath", "below", "under", "underneath"],
      "snahm": ["(motion) below", "beneath", "under", "underneath"],
      "thok": ["at", "located at"],
      "thahk": ["to", "towards"],
      "thuk": ["not at", "absent from"],
      "thehk": ["away from"]
    },
    "valency": {
      "gahn": ["reciprocal"],
  ...
  "verb": {
    "experiencer intransitive": {
      "dijin": ["resonate", "ring"],
      "duht": ["(in a game) be the one who's turn it is", ["example", "Duhtum du mahn, thefam deketfeh golm du.", "When it is someone's turn, they must remove a stone."]],
      ...
      "nelgyn": ["be sealed in something, (not locked in)"],
      "solsolmxaslem": ["fade from one color to another"],
    ...
    "intransitive": {
      ...
      "sazyc": ["go on vacation"],
      "sesuht": ["sing Let It Go"],
      "shaslaxac": ["act in an emotionally imbalanced way"],
      "slac": ["walk"],
      "slackah": ["run"],
      "sliktan": ["agree"],
      "slitacuhn": ["assert dominance using whale noises"],
      ...
      "vyc": ["do something", "act (not theater)"],
      ...
      "zagislult": ["kneel"],
      "zamen": ["hope"],
      "zanolcam": ["stand", "stand up straight"],
    ...
    "transitive": {
      ...
      "dafmuhm": ["point"],
      "dak": ["learn", ["archaic", "(no replacement)"]],
      ...
      "gafnulm": ["steal"],
      "gajin": ["hail", "salute"],
      "gamik": ["surprise", "shock", ["etymology", "gajin, gamyk, mik"]],
      ...
      "thnydat": ["mimic", "pantomime"],
      "tho": [["archaic", "thek"], "scribble", "scrawl"],
      "thycam": ["read"],
      "tizen": ["enable"],
      "tolthim": ["want", "desire"],
      "tolthimgoltzhut": ["grant a wish", "fulfill", "satisfy"],
      "tolzlnoln": ["inundate"],
      "tuhkykyt": ["mix"],
      ...
      "zan": ["be", "is"],
      "zanek": ["compose", "grow"],
      "zec": ["coin a very specific word for the sake of a translation or some other short-term goal, especially if the word is short and the definition is excessively long"],
      "zen": ["invite"],
      "zevec": ["translate"],
      "zeslit": ["encourage"],
      ...
      "zlulsak": ["cause psychological horror", "horrify"],
      "zmet": ["build"],
      "znim": ["fall into (quirky case: object takes -thot)"],
      "znolc": ["gather", "collect"],
      "znols": [["archaic", "znolc"], "gather", "collect"],
      "zolshen": ["forgive", "reconcile with someone", "do away with animosity or discord"],
      "zuht": ["coordinate", ["etymology", "zult"]],
      "zynamat": ["make an audio recording", "impersonate or mimic a voice"],
