...
var lexicon = {
  "adj": {
    ...
    "zhazhuhn": ["chaotic"],
    "zlnyfolvik": ["broad", "flat, but also long and thin"],
  ...
  "noun": {
    ...
    "jyt": ["place", ["etymology", "jymin"], "space (not strictly outer)", "spot", "location", "point"],
    "jythak": ["strawberry"],
    "kacfic": ["past"],
    ...
    "kygykmolm": ["group of people who eat meals together", "focus group", "interest group", "caucus"],
  ...
  "verb": {
    "experiencer intransitive": {
      ...
      "thehkshikxeht": ["be unable to move"],
