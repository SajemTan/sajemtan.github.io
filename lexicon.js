...
var lexicon = {
  ...
  "conjunction": {
    "both": {
      ...
      "xoksmah": ["not X but Y", "Y used as X", "Y in place of X", ["example", "thefamah xoksmah gafuhtah", "not stones but bricks, bricks used as stones, bricks in place of stones, bricks for stones"], ["gloss", "butrather"]]
    },
    "clause": {
      "dom": ["because"],
  ...
  "noun": {
    ...
    "vmanduhkjidolk": ["rose"],
    "vmak": ["a piece of furniture meant for sitting upon", "a chair", "seat", ["gloss", "chair"]],
    "vmedyt": ["projectile"],
    ...
    "finoln": ["lapis lazuli"],
    "fnoltefmim": ["comma, a place to pause while reading"],
    "fnyzlnelk": ["opal"],
    "fynan": ["amethyst"],
    "gajinthnu": ["faith", "spirituality"],
    "geshek": ["time"],
    "geshekzlulc": ["a relatively long period of time"],
    "geshekzlulcfun": ["moment"],
    "julgiczlulc": ["a question"],
    "kacznolk": ["yesterday"],
    ...
    "slnazlam": ["the place from where members of polural systems control the body; equivalent to the term front in the plurality community"]
  },
  "number": {
    "decimal": {
      "dec": ["1"],
  ...
  "verb": {
    ...
    "transitive": {
      ...
      "gygit": [" to be sorry in the sympathetic rather than apologetic sense"],
      "gyvnam": ["cook"],
      ...
      "sesult": ["yell"],
      "shasholc": ["partake", "participate"],
      "shelgin": ["perceive"],
      "shmithuln": ["allow", "permit"],
      "shynzhut": ["to inform (regarding abstract things)"],
      ...
      "vulznicen": ["to wind", "to lash (sth together)", "to whip (a rope)"],
      ...
      "xexensitukzhut": ["to prepare", "to set up (quirky case: object takes -thot)"],
      ...
      "zisnam": ["to cover sth with a substance", "to paint", "to coat", ["etymology", "zic + snam"]],
      "zixmyn": ["to puncture (a pressurized object)"],
      ...
      "zlnulthnuhn": ["to scratch (a line)", "to engrave", "to inscribe"],
      "zmet": ["build"],
