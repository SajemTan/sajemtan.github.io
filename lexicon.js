...
var lexicon = {
  "adj": {
    ...
    "cimuht": ["equal", "same"],
    "cimuhtsholmak": ["regularly spaced", "at regular intervals"],
    ...
    "femek": ["noetic"],
    "femeksnymmeht": ["zoned out", "foggy"],
    "fic": ["current"],
    "fikzhnu": ["dead"],
    "fmuhzhik": ["dry"],
    "gagan": ["primary", "main"],
    "gamiksezhulfen": ["serendipitous"],
    "gamiktheln": ["sudden"],
    ...
    "jam": ["new"],
    "jelk": ["full"],
    "julvnolkthnumeht": ["waiting"],
    "jyt": ["spatial"],
    "kak": ["darkened"],
    "kek": ["supplemental", "more"],
    "ketit": ["bitter"],
    "ketoln": ["pungent"],
    "kevyfyt": ["wild"],
    "kolvnycmeht": ["aspirated"],
    "magolt": ["valuable"],
    "mam": ["female", "feminine"],
    "mehn": ["some", "any"],
    "men": ["normal", "average", "regular"],
    "menec": ["false, fake"],
    ...
    "sazemok": ["not divisible by (of a number)", ["example", "fam sazemok", "not divisible by two, odd"]],
    "selset": ["cozy", "comfy"],
    "semet": ["numerical"],
    "shafolm": ["warm"],
    "shit": ["high-quality", "advanced", "high-level"],
    ...
    "thefmin": ["forked", "branched"],
    "theln": ["fast", "quick (of processes/actions other than motion verbs)", "rapid", ["example", "Kizhult theln fmyvuhkfeh tanzlulctucah.", "Bee coins words quickly."], ["see also", "solm"]],
    "thelnfemek": ["clever"],
    "thik": ["thin (of an object)"],
    "thikit": ["sturdy", "resistant", "unyielding"],
    "thin": ["large (of a person)"],
    "thnelxmyt": ["flat"],
    "thnoln": ["free", "unrestrained"],
    "tishnim": ["sleepy", "tired"],
    ...
    "zhazhuhn": ["chaotic"],
    "zlnyfolvik": ["flat, but also long and thin"],
  ...
  "conjunction": {
    "both": {
      ...
      "xoksmah": ["not X but Y", "Y used as X", "Y in place of X", ["example", "thefamah xoksmah gafuhtah", "not stones but bricks, bricks used as stones, bricks in place of stones, bricks for stones"], ["gloss", "but.rather"]]
    },
    "clause": {
      "dom": ["because"],
  ...
  "noun": {
    ...
    "culjim": ["ant"],
    "culjimdin": ["anthill"],
    "cult": ["axiom", "truth univerally acknowledged", "fact"],
    "cyfek": ["algae"],
    ...
    "duhgan": ["circle", "ring", "loop"],
    "duhgangolduhn": ["sphere", "ball", "bulb"],
    "duhk": ["spear"],
    ...
    "geshik": ["clock", "sundial", "timekeeper", "watch"],
    ...
    "golslim": ["photograph"],
    "golt": ["limit", "boundary", "termination point", "end", "edge"],
    ...
    "jyt": ["place", ["etymology", "jymin"], "space (not strictly outer)", "spot", "location", "point", "position"],
    "jythak": ["strawberry"],
    "kacfic": ["past"],
    ...
    "kyvydyc": ["crack", "tear", "hole", "ravine", "chasm"],
    "madam": ["history"],
    "magolt": ["value", "worth"],
    ...
    "snac": ["element", "chemical element", "basic substance", ["etymology", "dasnan + tuc"]],
    ...
    "tanik": ["saxophone"],
    "tanzlulc": ["utterance", "short speech", "sentence", "dollop of honey", "message", "statement"],
    ...
    "tolmolm": ["slope", "slanting area"],
    "tolthim": ["wants", "desires"],
    "tolzen": ["mist", "fog"],
    "tolzlneln": ["water"],
    ...
    "tult": ["object", "thing"],
    "tultxeht": ["nothing"],
    "tulvmyzam": ["cloth", "fabric", "textile"],
    ...
    "vigyn": ["mystic", "witch (definition archaic)"],
    ...
    "vmanduhkjidolk": ["rose"],
    "vmak": ["piece of furniture meant for sitting upon", "chair", "seat", ["gloss", "chair"]],
    "vmedyt": ["projectile"],
    ...
    "vanysleln": ["collection of loosely connected thoughts", "hodgepodge", "book containing scattered writings", "zibaldone", "commonplace book"],
    ...
    "teslin": ["spoonerism"],
    "znolvulc": ["mushroom"],
    "zhajek": ["ocelot", "foreigner", "ambassador", "wildcat"],
    "shaslaxac": ["Hormone"],
    ...
    "tolcen": ["efficiency"],
    "thezen": ["when fog and wind snipe at each other"],
    ...
    "kevyfytzhnicoln": ["dingo", "wild dog", "wolf"],
    "fmaslnolt": ["trout"],
    ...
    "kulsacjidolk": ["palm flower"],
    "zhmiznolzlmezhulzlnulc": ["anchovy"],
    "shmoldulvmulnesolm": ["extract"],
    "kemenfynit": ["beef"],
    "zlnolthnen": ["bone"],
    "fniznejuhxuhfnik": ["bonito (fish)"],
    "zhnulxnelthmulshyzhnak": ["sardine (fish)"],
    "snezhadethmulzlnulm": ["clam"],
    "xmelsyc": ["starch"],
    "zhnulcizlnavmolshmen": ["cuttlefish"],
    "fmazlyn": ["weed", "unwanted plant"],
    "folxolt": ["clan", "society"],
    "tulzhnolmvolt": ["industrial hemp"],
    "tolzlnelntulchnolmvolt": ["inedible seaweed"],
    "folxmelzhicolmuht": ["edible seaweed"],
    "zlmulvmuhvnesuhm": ["mussel"],
    "shmathnolsnuhzhithneln": ["sand lance (fish)"],
    "shnezlnelzolt": ["tuna"],
    "fmavmulsolvnisnyt": ["guar (plant, not the creature from Morrowind)"],
    "snelshyzhamulk": ["chewing gum"],
    "muhxektult": ["monosodium glutamate"],
    "thmulzevinat": ["yeast"],
    "slmolslmuhslnec": ["worcestershire sauce"],
    "zhulsnem": ["laver (a type of edible seaweed)"],
    "fmuhmasnulslmuhzlnuhn": ["cabbage"],
    "thnuhzhmakelthnulfmuhm": ["leek"],
    "zuhmuhcolthmizhek": ["radish"],
    "xnelshmym": ["tapioca"],
    "tavim": ["pea"],
    "thnolzhyk": ["sea squirt"],
    "gigigygym": ["flip-flop", "sandal"],
    "gigigygymdejizoln": ["sandalwood"],
    "zlnefnuln": ["resin (of a tree)"],
    "fmulzlulm": ["benzoin (incense)"],
    "snuljic": ["myrrh"],
    "mevman": ["frankincense"],
    "thezolm": ["patchouli"],
    "fikolc": ["mint"],
    ...
    "sluhvnult": ["oregano"],
    "zlmavelc": ["marjoram"],
    "tazlik": ["wine as a cooking ingredient"],
    "jolguhmnenyk": ["tarot card"],
    "gelnult": ["magic wand"],
    "fmazlyk": ["chalice"],
    "thelkolt": ["pineapple"],
    "shekelk": ["cardinal", "redbird"],
    "kulzhek": ["spearmint"],
    "zlezlmult": ["valerian (herb)"],
    "xuhzlman": ["lemongrass"],
    "xuhzlmangamyk": ["eucalyptus"],
    "kelzhnult": ["safflower"],
    "cishneln": ["rhubarb"],
    "zlmelzlec": ["camouflage"],
    "thmulvnyk": ["chamomile"],
    "delgolm": ["licorice"],
    "slnazlnemulthnythmuhnik": ["lancelet"],
    "gislmulcythmuhzhnytek": ["pufferfish"],
    "gislmulcythmuhzhnytekzhizlik": ["fugu"],
    "slak": ["gar (fish)"],
    "tezetzatolk": ["electric eel"],
    "zlnashnyjuhvmethmishmulc": ["minnow"],
    "xmolxmolm": ["lamprey"],
    "xmolxmolzlmeshmolthyjen": ["marlin"],
    "zhmelslolzheslyzlolthik": ["barracuda"],
    "vmemuhsnulzlnec": ["cutlass"],
    "vmemuhsnulzlneczhizlik": ["cutlassfish"],
    "vaxik": ["mackerel"],
    "thmelfelt": ["swordfish"],
    "tythemekzhizlik": ["anglerfish"],
    "tythemekmazuhn": ["insect"],
    "fmishnic": ["salamander"],
    "thelzlnolm": ["toad"],
    "denim": ["canola (plant)"],
    "mim": ["alcohol"],
    "timemzhnazym": ["bed"],
    "kelmfun": ["slip (of paper)", "card (e.g. credit card, business card)", "punchcard", "note (e.g. doctor's note)", "coupon", "ticket"],
    "geseltfun": ["pixel"],
    "geseltfundolkat": ["a piece of pixel art"],
    "geseltfundolkatnem": ["pixel art"],
    "geseltfuntulvmyzam": ["pixel art quilt"],
    "zelvetdat": ["morning, daybreak", "sunrise", "dawn"],
    "themultmon": ["database", "catalogue"],
    "themultsazemgyn": ["keyword"],
    "kyfixnulm": ["hug"],
    "thozlolt": ["snow", ["see also", "melsulntelzlnoln"]],
    ...
    "fanin": ["sapphire"],
    "felnnoc": ["information (regarding people or places)"],
    "finoln": ["lapis lazuli"],
    "fnoltefmim": ["comma", "place to pause while reading"],
    "fnyzlnelk": ["opal"],
    "fynan": ["amethyst"],
    "gajinthnu": ["faith", "spirituality"],
    "geshek": ["time"],
    "geshekzlulc": ["relatively long period of time"],
    "geshekzlulcfun": ["moment"],
    "julgiczlulc": ["question"],
    "kacznolk": ["yesterday"],
    "kat": ["right (the direction relative to the speaker)"],
    "kekzhnu": ["addition"],
    "kikim": ["idea", "thought"],
    "metolgyxantuc": ["post (online)"],
    "nanak": ["jackfruit"],
    "shitgyn": ["expert", "master"],
    "shynnoc": ["information (regarding abstract things)"],
    "sidulcfynit": ["muscle"],
    "slingynmon": ["army"],
    "slinthnu": ["war"],
    "snedelmgamik": ["a surprise, specifically one that is intentional"],
    "snijatmon": ["mountain range"],
    "snijatmonfenat": ["camel"],
    "snolzemfynit": ["tendon"],
    "soljemkuhtynak": ["paint"],
    "solmsolsolm": ["speed"],
    "tanzlulcmon": ["phrasebook", "testimony"],
    "tasnan": ["rose quartz"],
    "tasnin": ["carnelian"],
    "tefmim": ["dot", "point", "mark", "nick", "punctuation"],
    "telsneln": ["pearl"],
    "tesnan": ["garnet"],
    "thakmim": ["wine (not used for cooking)"],
    "themekmolm": ["committee", "creative team", ["etymology", "themek + molm"]],
    "timemtulvmyzam": ["stretcher", "hammock"],
    "tysec": ["hole", "gap", "space"],
    "tysnuln": ["ruby"],
    "vmolc": ["left (the direction relative to the speaker)"],
    "vuhslinit": ["pancake, especially a blini or crepe"],
    "vulznicenfynit": ["ligament"],
    "vynitgeshekzlulc": ["delay"],
    "xamet": ["humor"],
    "xolzhymuln": ["championship game", "final match"],
    "xulmehk": ["increase"],
    "xytjot": ["future"],
    "zezholtdultham": ["vending machine for non-food items"],
    "zheguht": ["peridot"],
    "zicuhmdultham": ["vending machine for food/drinks"],
    "zlamen": ["rope", "cord"],
    "zlamenfun": ["string"],
    "dejizolzen": ["fogwood tree", "the wood of the fogwood tree", ["etymology", "dejizoln + tolzen"]],
    "fmult": ["left (the direction relative to the person being addressed)"],
    "fnoltyt": ["harbour", "bus stop", "train station", ["etymology", "fnolt + jyt"]],
    "tenik": ["glue", "adhesive"],
    "tulvmyzamtuc": ["yarn", ["see also", "zlamen"]],
    "fmigek": ["burrow", "hole"],
    "zixmyn": ["leak", "spurt"],
    "fuhjin": ["corrosion", "pit(ing)"],
    "tholmit": ["slang", "jargon", "street talk, or creole - a simplified form of one or more contributing languages, often with gratuitous use of contractions"],
    "slnazlam": ["place from where members of polural systems control the body; equivalent to the term front in the plurality community"],
    "dulznuhk": ["slit"],
    "slingynmon": ["military"],
    "thuhfamzlamen": ["wire"],
    "xesloln": ["turtle"],
    ...
    "cuhcnaket": ["sock"],
    "nicnaket": ["glove"],
    "timemnaket": ["sleeping bag"],
    "sezelcnaket": ["bag", "backpack"],
    "tulxyktulvmyzam": ["sail"],
    "soljemzic": ["ink"],
    "zicthekam": ["pen"],
    "nulvmicsnac": ["Carbon"],
    "nulvmicthekam": ["pencil"],
    "sezhulfenzhnu": ["discovery", "that which has been discovered/uncovered/found"],
    "golmsnamtult": ["debt"],
    "mazlavak": ["wool"],
    "mazlavakefam": ["asbestos", ["etymology", "mazlavak + thefam"]],
    "mazlavakolt": ["cotton", ["etymology", "mazlavak + volt"]],
    "kolvnyc": ["breath"],
    "dijecnaket": ["pocket"],
    "dijec": ["connection"],
    "moltenslafyc": ["street", "paved road"],
    "vulcnoc": ["consequence"],
    "tazlnat": ["weather", ["etymology", "triconsonantal root t_zln_t"]],
    "zheljuhknelculm": ["porridge", "oatmeal", "congee"],
    "kizikthisyn": ["blade of grass"],
    "dulmukmun": ["infant", "baby"],
    "thekzlulcnem": ["literature"],
    "gygiknemtuc": ["kind of food", "topic (of discussion, writing, etc.)"],
    "muhzlet": ["trip (to somewhere)", "journey"],
    "femekfuhmolt": ["brain"],
    "slisec": ["birch tree"],
    "jaxindin": ["school"],
    "snanolmzmet": ["school"],
    "jaxinvmatthnu": ["school work"],
    "vmat": ["center", "middle"],
    "thefmin": ["angle"],
    "duhfnetthefmin": ["angle (of a polygon)"],
    "kygykmolm": ["group of people who eat meals together", "focus group", "interest group", "caucus", "board (e.g. of directors)"],
    "nanandidit": ["fire hydrant"],
    "zik": ["current"],
    "zheljuhkzicuhm": ["kettle"],
    "shizuht": ["memory"],
    "thulxadak": ["herald", "one who calls out names of players before a sporting match using antiquated speech"],
    "tolzenkah": ["steam"],
    "suhzhnolm": ["pleasure"],
    ...
    "cak": ["Wingbeat (Sajem Tannic measurement = 4 milliseconds)"],
    "cetolc": ["rod", "pole", "stick"],
    "cimuhtsazemnocmon": ["scale (e.g., of temperature)", "gradations"],
    "citin": ["keratin"],
    "colvik": ["pipe", "tube", "conduit"],
    "daketsolsolm": ["nearness", "distance"],
    "delgem": ["selection", "choice"],
    "delgemnem": ["selection of ___"],
    "dijecmon": ["network"],
    "duhtfnyn": ["thumb (not necessarily opposable)"],
    "duldulkthuhfam": ["brass"],
    "dyfnynkam": ["measuring device"],
    "dyfnynsolsolm": ["scale (of size etc.)"],
    "felgek": ["trailer", "hitch", "wagon"],
    "felgekmoncen": ["chain"],
    "fenatfelgek": ["horse carriage"],
    "fnoltcetolcfun": ["pin"],
    "fnoltthnelxmyt": ["brake disk"],
    "fuhjinkam": ["plane (tool)"],
    "gaganfynit": ["thorax", "chest"],
    "geseltkah": ["kiln", "oven"],
    "gisnolmnoc": ["injury", "wound"],
    "gyngizlethnyt": ["(work) boots"],
    "jamfelnnoc": ["news"],
    "jikintuc": ["note"],
    "juhcencetolcfun": ["match"],
    "kaksolsolmtuc": ["shade (of a color)"],
    "kazlyt": ["arch (especially one which can be walked on)"],
    "kezlatin": ["chitin"],
    ...
    "shitsolsolm": ["quality"],
    "slacak": ["step", "pace"],
    "slmelzlmytkam": ["hammer", "sledgehammer"],
    "sluhtduhfnet": ["square"],
    "snamkikim": ["suggestion"],
    "tazlikthak": ["grape"],
    "tazlikthakukmun": ["olive"],
    "telmyn": [ "sth. heavy, especially when referring to sth. that must be moved"],
    "telmynnoc": ["back pain"],
    "telmynsolsolm": ["weight"],
    "thefminjyt": ["vertex"],
    "thefmintuc": ["division", "branch", "fork", "offshoot"],
    "thelfneln": ["tardigrade"],
    "thulntult": ["opinion"],
    "thynim": ["horn", "cone"],
    "tolnthuhfam": ["bronze"],
    "vmatmun": ["exact center"],
    "voltcetolc": ["stem (of a plant)"],
    "xataxymzhan": ["spade"],
    "xenzlulc": ["error", "mistake"],
    "xolnet": ["lace", "net", "loose mesh"],
    "zathelntulvmyzam": ["silk"],
    "zelvetjin": ["sunlight", "starlight", "the idea that every emotion is essentially a passing fragment of an illusion"],
    "zelvetjinxeht": ["shade"],
    "zhanthuhfam": ["steel"],
    "zlnyfolvik": ["board"],
    ...
    "toltak": ["flicker"],
    "kixat": ["cold", "flu", "chill"],
    "koljat": ["pottery wheel", "any tool or work surface which rotates", ["etymology", "from Xanz kója'"]],
    "jingeselt": ["lampshade", "lantern", "sconce", "any container for a light source"],
    "zenek": ["lock", "bar", "barrier to entering a building"],
    "nanymmolshnem": ["penpal"],
    "donkasyn": ["rhyme", "assonance"],
    "xataxymkam": ["shovel"],
    "fnynzhan": ["fingernail"],
    "tolzlnelncolvikgyn": ["plumber"],
    "velzynzholgam": ["werewolf"],
    "nyzickygyn": ["vampire", "hemophage", "hematophage"],
    "fmuhzhikfikzhnufynit": ["mummy"],
    "zathelnxolnet": ["web"],
    "slinfnulsninaket": ["helmet"],
    "tezleknoc": ["expectation, particularly of something slightly negative (topic of expectation takes -thot)", ["gloss", "expectation"]],
    "veslek": ["trust"],
    "xananzmetthnak": ["foundation of a building", ["gloss", "foundation"]],
    "metzhutthnu": ["revolution"],
    "nulnukmun": ["enemy"],
    "slythyzlyn": ["dragon"],
    "shimulc": ["nature", "essence"],
    "solmjin": ["tachyon", "any faster-than-light particle"]
  },
  "number": {
    "decimal": {
      "dec": ["1"],
  ...
  "post": {
    ...
    "xifemgolt": ["realize that", ["example", "Dulkatum zloahvmeh xaslolmgynah theh xifemgolt", "I realized that it's legs were as long as two Tetanah."]],
    "zet": ["knowing wisdom/silliness", ["see also", "feln"], ["see also", "shyn"]],
    "zult": ["after", "once", "soon after", "in accordance with", "following", "in the opinion of"],
    "zyshen": ["help"]
  },
  "prefix": {
  ...
  "pronoun": {
    ...
    "zlah": ["null pronoun used to introduce complement clauses", ["gloss", "CMPL"], ["example", "Mu sliktanfeh vu om zlah tholthimfeh theh.", "I want you to agree."]],
  ...
  "suffix": {
    ...
    "noun>noun": {
      ...
      "cahc": ["indicates a sensual attraction"],
      ...
      "kahk": ["indicates a s*xual attraction"],
      "mahk": ["improver"],
      "mahm": ["indicates a quirkyplatonic attraction"],
      ...
      "nahn": ["indicates a romantic attraction"],
      "nemtuc": ["kind of", "type of", "sort of"],
      ...
      "taht": ["indicates a platonic attraction"],
      "tuc": ["part of"],
      "zhum": ["pet"]
    },
    "noun>trans": {
    ...
    "pseudo-case": {
      ...
      "slahc": ["onto the surface of"],
      "sluc": ["away from the surface of"],
      "slehc": ["(motion) away from the surface of"],
      "snum": ["atop", "on top of", "above"],
      "snehm": ["to the top of", "up from the bottom of", "moving vertically upwards"],
      "snom": ["beneath", "below", "under", "underneath"],
      "snahm": ["(motion) below", "beneath", "under", "underneath", "moving vertically downwards"],
      "thok": ["at", "located at", "adjecent to"],
      "thahk": ["to", "towards"],
    ...
    "valency": {
      ...
      "jahk": ["in order to"],
      "sun": ["passive voice"],
      "zlah": ["impersonal", ["suf-example", "telzlnolnsho snym (the cloud is raining)", "telzlnolnshozlah (it is raining)"]]
    },
    "verb>noun": {
  ...
  "verb": {
    "experiencer intransitive": {
      ...
      "kasyn": ["recur"],
      "kelgyn": ["remain", "be left over"],
      "kem": ["shake", "vibrate"],
      "kixat": ["be sick (non-life-threatening)", ["gloss", "sick"]],
      "kolvnyc": ["breathe"],
      "muhshim": ["be cool", "be awesome"],
      "nelgyn": ["be sealed in something, (not locked in)"],
      "solsolmxaslem": ["fade from one color to another"],
      "snolzem": ["get tangled up"],
      "thehkshikxeht": ["be unable to move", "be stuck"],
      "thnadyc": ["die (poetic)", ["see also", "fik"]],
      "timem": ["lie (of an object)"],
      "timemehkfun": ["doze off"],
      "vulc": ["come to pass", "happen", "occur"],
      "zan": ["exist"],
      "zanek": ["grow", "develop"],
    ...
    "experiencer transitive": {
      "cimuht": ["equal"],
      "cimuhttuhtuk": ["be at a consistent scale to sth else"],
      "cult": ["know"],
      ...
      "tezlek": ["worry", "be concerned about", "wonder"],
    ...
    "intransitive": {
      ...
      "slac": ["walk"],
      "slackah": ["run", "skip", "walk/run with a manic gait"],
      "sliktan": ["agree"],
      "sliksesult": ["agree enthusiastically", "strongly support"],
      "slitacuhn": ["assert dominance using whale noises"],
      "slnaxan": ["idly chat despite not wanting to"],
      "slnazlam": ["front", "be in front"],
      "slolslac": ["crawl"],
      ...
      "thekat": ["sneak", "move with stealth"],
      "tho": [["archaic", "thek"], "scribble", "scrawl"],
      "thulxadak": ["announce", "herald"],
      "timem": ["sleep"],
      ...
      "xentan": ["disagree"],
      "xensesult": ["argue", "debate loudly"],
      "xidat": ["multi-task"],
      "xifemgolt": ["realize something", "achieve mental satisfaction"],
    ...
    "transitive": {
      ...
      "dulthamukmun": ["sell"],
      "dyfnyn": ["measure"],
      "felgek": ["drag sth (behind) oneself"],
      ...
      "fmyvuhk": ["make", "create"],
      "fnolt": ["fasten", "attach"],
      "fuhjin": ["scratch", "pit", "peel (a carrot or potato)", "shave", "plane"],
      ...
      "gygit": ["condole", "be sorry in the sympathetic rather than apologetic sense"],
      "gyvnam": ["cook"],
      ...
      "keceksozhut": ["give a haircut"],
      "kek": ["add", "sum"],
      "kem": ["shake", "cause to vibrate"],
      "kishnulm": ["spin"],
      "kyfixnulm": ["hug"],
      "kyguhk": ["digest", "incorporate"],
      ...
      "sesult": ["yell"],
      "shasholc": ["partake", "participate (quirky case: object takes -thot)"],
      "shelgin": ["perceive"],
      ...
      "sithafulk": ["practice", "train"],
      "slin": ["fight"],
      "slitacuhn": ["look down at someone's head"],
      "slmelzlmyt": ["smash", "pound", "hit"],
      "slnolxem": ["sing"],
      ...
      "snanolm": ["learn"],
      "snamukmun": ["deprive (thing is object and person is -thot)", ["gloss", "deprive"]],
      "soldyc": ["describe"],
      ...
      "tho": [["archaic", "thek"], "scribble", "scrawl"],
      "thokzhut": ["put something somewhere", "station", "position"],
      "thycam": ["read"],
      "tizen": ["enable"],
      "tolthim": ["want", "desire"],
      "tolthimgoltzhut": ["grant a wish", "fulfill", "satisfy"],
      "tolzlnelnnoc": ["rinse", "wash", "bathe", "immerse in water (without intensive scrubbing)"],
      "tolzlnoln": ["inundate"],
      "tuhkykyt": ["mix"],
      ...
      "zlulvolm": ["wear", "use (a desk)", "sit on (a chair)"],
      "zlnulthnuhn": ["scratch (a line)", "engrave", "inscribe"],
      "zmet": ["build"],
